...
export const writings: Writing[] = [
  {
    ...
    description:
      'Authored Chapter 15, "Convergence & Innovation: Connected Agents, Complicating Control," and Chapter 17, "Sovereignty & Security: Control and Responsibility in the Age of AI Security."',
    links: [],
  },
  {
    id: 'chi-2026',
